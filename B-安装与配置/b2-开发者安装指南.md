...
## 使用tModLoader进行开发
在开始之前，您需要两样东西：".NET 8 SDK"和一个合适的IDE。安装这些后，您应该从[基础模组开发指南](a3-基础模组开发指南.md)开始。
...
## 我回归模组制作
如果您以前制作过tModLoader模组，并且想要更新过时的模组或制作新模组，tModLoader API很可能已更改。请阅读[更新迁移指南](Update-Migration-Guide.md)，了解您在阅读[tModPorter部分](Update-Migration-Guide.md#tmodporter)后错过的版本。如果有任何问题，您可以在Discord中提问。
